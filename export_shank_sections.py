...
设计依据:
  - 桨柄椭圆截面 → DU 翼型的平滑过渡
  - 法兰面 PCD≈180 mm, 8×M16 → 外径包络 ≥200 mm
  - 桨柄厚度 50→80 mm: 铺层 ply drop 累积区 + 离心承拉
========================================================
"""
...
# thickness = 最大厚度 (mm)
SHANK_STATIONS = [
    (0.200, "ellipse", -100, +100,  50,  0.0),   # 法兰面: 紧凑椭圆, 中心在桨距轴
    (0.350, "ellipse", -125, +157,  58,  9.0),   # 桨柄中段
    (0.500, "ellipse", -150, +260,  80, 14.0),   # 桨柄末端, 开始膨胀
    (0.580, "blend",   -164, +329, 105, 16.0),   # 过渡形: LE/TE 加速向 DU 靠拢
]
