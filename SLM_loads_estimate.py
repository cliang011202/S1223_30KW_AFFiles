...
# ---- 叶片质量特性 — 全碳方案核定 (2026-05-26) ----
m_B          = 12.5    # 单叶质量 [kg]      (全碳方案 BOM 核定)
R_cog        = 1.2     # 叶根→质心距 [m]   (BOM COG 加权: 根部集中质量 3.5kg@0.06m 拉低 COG)
...
# ---- 叶根螺栓校核 (2026-05-26 更新, 匹配 Root Connection Design) ----
n_bolts        = 12
bolt_PCD       = 0.21  # 螺栓节圆直径 [m]
bolt_label     = "M16 10.9"
bolt_proof_kN  = 143.0 # M16 10.9 屈服拉力 ≈ 143 kN
